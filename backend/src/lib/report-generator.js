...
function cvssHandle(data) {
    // Header title colors
    var lowColor = "00b0f0"; //blu
    var mediumColor = "ffc000"; //yellow
    var highColor = "ff0000"; //red
...
function prepAuditData(data) {
    ...
    data.findings.forEach(finding => {
        var tmpFinding = {
            ...
            observation: finding.observation.replace(/(&([a-z0-9]+|#[0-9]{1,6}|#x[0-9a-f]{1,6});|(<\w+>|<\/\w+>)+)/gmi, '') || "",
